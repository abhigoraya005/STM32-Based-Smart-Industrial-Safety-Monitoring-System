...
uint32_t machine_runtime = 0;
uint32_t maintenance_limit = 30;

uint8_t maintenance_due = 0;
...
void Check_Alerts(void)
{
    ...
    if(machine_runtime >= maintenance_limit)
    {
        maintenance_due = 1;
...
"Machine Runtime   : %lu hrs\r\n"
"Maintenance Limit : %lu hrs\r\n"
"\r\n"
"Gas Value         : %lu %%\r\n"
"Temp Value        : %lu %%\r\n"
"Distance Value    : %lu %%\r\n"
